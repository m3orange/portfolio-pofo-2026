...
<body class="citybox">
    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-12 text-left margin-100px-bottom md-margin-50px-bottom sm-margin-30px-bottom">
                    <h4 class="font-weight-300 text-extra-dark-gray margin-15px-bottom">Mammut Interactive Corporate
                        Design</h4>
                    <span
                        class="text-deep-pink text-large border-bottom border-color-deep-pink font-weight-300">Branding
                        Design &nbsp;+&nbsp;&nbsp; Magento Development &nbsp;+&nbsp;&nbsp; Mobile Website &nbsp;+&nbsp;
                        eNewsletter</span>
                </div>
                <div
                    class="col-12 col-lg-6 line-height-28 last-paragraph-no-margin md-margin-50px-bottom sm-margin-30px-bottom wow fadeIn">
    ...
    <section class="bg-extra-dark-gray">
        <div class="container-fluid padding-five-lr md-padding-30px-lr">
            <div class="row">
                <!-- start product item -->
                <div class="col-12 col-md-5 sm-margin-30px-bottom wow fadeInUp">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 text-center wow fadeInUp">
                    <img src="http://placehold.it/1526x782" alt="" />
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- start section - from home-classic-innovation-agency-->
    <section class="wow fadeIn p-0 main-slider mobile-height content-right-slider">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 col-lg-7 cover-background md-height-500px sm-height-350px wow fadeIn"
                    style="background-image:url('images-fpo/fpo-1920x955.jpg')"></div>
                <div
                    class="swiper-full-screen swiper-container col-12 col-lg-5 px-0 white-move bg-extra-dark-gray text-center sm-padding-20px-tb wow fadeIn">
                    <div class="swiper-wrapper">
                        <!-- start slider item -->
                        <div class="swiper-slide last-paragraph-no-margin">
                            <div
                                class="padding-eighteen-all lg-padding-eight-all md-padding-thirteen-all sm-padding-15px-lr">
                                <div class="margin-30px-bottom text-center position-relative">
                                    <span class="title-large alt-font font-weight-300 text-dark-gray opacity4">01</span>
                                    <p
                                        class="alt-font font-weight-600 text-deep-pink text-uppercase position-absolute left-0 right-0 top-35 md-top-25 sm-top-12">
                                        Let’s make something beautiful</p>
                                </div>
                                <h4 class="alt-font text-white-2">Unlimited power and customization possibilities</h4>
                                <p class="width-90 md-width-95 sm-width-85 mx-auto">Lorem Ipsum is simply dummy text of
                                    the printing and typesetting industry. Lorem Ipsum has been the industry's standard
                                    dummy text ever since. Lorem Ipsum has been the industry. Lorem Ipsum has been the
                                    industry's standard dummy text since. Lorem Ipsum is simply dummy text of the
                                    typesetting industry.</p>
                                <a href="about-us-classic.html" class="btn btn-small btn-white margin-35px-top"> About
                                    company</a>
                            </div>
                        </div>
                        <!-- end slider item -->
                        ...
                        <div class="swiper-slide last-paragraph-no-margin">
                            <div
                                class="padding-eighteen-all lg-padding-eight-all md-padding-thirteen-all sm-padding-15px-lr">
                                <div class="margin-30px-bottom text-center position-relative">
                                    <span class="title-large alt-font font-weight-300 text-dark-gray opacity4">02</span>
                                    <p
                                        class="alt-font font-weight-600 text-deep-pink text-uppercase position-absolute left-0 right-0 top-35 md-top-25 sm-top-12">
                                        We are digital media agency</p>
                                </div>
                                <h4 class="alt-font text-white-2">We are delivering beautiful digital products for you
                                </h4>
                                <p class="width-90 md-width-95 sm-width-85 mx-auto">Lorem Ipsum is simply dummy text of
                                    the printing and typesetting industry. Lorem Ipsum has been the industry's standard
                                    dummy text ever since. Lorem Ipsum has been the industry. Lorem Ipsum has been the
                        ...
                        <div class="swiper-slide last-paragraph-no-margin">
                            <div
                                class="padding-eighteen-all lg-padding-eight-all md-padding-thirteen-all sm-padding-15px-lr">
                                <div class="margin-30px-bottom text-center position-relative">
                                    <span class="title-large alt-font font-weight-300 text-dark-gray opacity4">03</span>
                                    <p
                                        class="alt-font font-weight-600 text-deep-pink text-uppercase position-absolute left-0 right-0 top-35 md-top-25 sm-top-12">
                                        We create designs and technology</p>
                                </div>
    ...
    <!-- end section  - from home-classic-innovation-agency-->
                ...
                <div class="col">
                    <ul class="portfolio-grid work-4col hover-option4 lightbox-gallery">
                        ...
                        <li class="grid-item web branding design wow fadeInUp">
                            <a href="http://placehold.it/750x750" title="Armchair Mojo">
                                <figure>
                                    <div class="portfolio-img bg-extra-dark-gray"><img src="http://placehold.it/750x750"
                                            alt="" class="project-img-gallery" /></div>
                                    <figcaption>
                        ...
                        <li class="grid-item web branding design wow fadeInUp" data-wow-delay="0.2s">
                            <a href="http://placehold.it/750x750" title="Truenorth Web">
                                <figure>
                                    <div class="portfolio-img bg-extra-dark-gray"><img src="http://placehold.it/750x750"
                                            alt="" class="project-img-gallery" /></div>
                                    <figcaption>
                        ...
                        <li class="grid-item wow fadeInUp" data-wow-delay="0.4s">
                            <a href="http://placehold.it/750x750" title="Sean Cargo">
                                <figure>
                                    <div class="portfolio-img bg-extra-dark-gray"><img src="http://placehold.it/750x750"
                                            alt="" class="project-img-gallery" /></div>
                                    <figcaption>
                        ...
                        <!-- start portfolio item -->
                        <li class="grid-item wow fadeInUp" data-wow-delay="0.4s">
                            <a href="http://placehold.it/750x750" title="Mass Productions">
                                <figure>
                                    <div class="portfolio-img bg-extra-dark-gray"><img src="http://placehold.it/750x750"
                                            alt="" class="project-img-gallery" /></div>
                                    <figcaption>
    ...
    <!-- end product gallery section -->
        ...
        <!-- start product slider section - from single-project-page-02 -->
        <section class="wow fadeIn p-0">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="swiper-blog white-move">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide width-50 md-width-80 sm-width-100">
                                    <img src="images-fpo/fpo-800x533.jpg" class="width-100" alt=""/>
                                </div>
                                <!-- end slider item -->
                                <!-- start slider item -->
                                <div class="swiper-slide width-50 md-width-80 sm-width-100">
        ...
        <!-- end product slider section  - from single-project-page-02 -->
    ...
    <section class="wow fadeIn">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 col-xl-12 col-lg-12 mx-auto margin-eight-bottom text-center">
                ...
                <div class="col filter-content overflow-hidden">
                    <ul class="portfolio-grid work-2col hover-option4 gutter-medium">
                        ...
                        <li class="grid-item web branding design wow fadeInUp">
                            ...
                            <figure>
                                <div class="portfolio-img bg-extra-dark-gray"><img src="images-fpo/fpo-800x800.jpg" />
                                </div>
                                <figcaption>
                                    <div class="portfolio-hover-main text-center">
                                        <div class="portfolio-hover-box align-middle">
            ...
            <div class="row no-gutters">
                <div class="col filter-content overflow-hidden">
                    <ul class="portfolio-grid work-1col hover-option4 gutter-medium">
                        <li class="grid-sizer"></li>
                        <!-- start portfolio item -->
                        <li class="grid-item web branding design wow fadeInUp">

                            <figure>
                                <div class="portfolio-img bg-extra-dark-gray"><img src="images-fpo/fpo-1920x955.jpg" />
                                </div>
                                <figcaption>
                                    <div class="portfolio-hover-main text-center">
                                        <div class="portfolio-hover-box align-middle">
