                ...
                <div class="slider-text-middle-main">
                    <div class="slider-text-bottom">
                        <div class="col-12 col-xl-6 col-lg-7 float-right bg-orange-opacity padding-five-lr lg-padding-four-lr padding-four-tb sm-padding-30px-all last-paragraph-no-margin">
                            ...
                            <h3 class="font-weight-500 text-white-2 width-95 md-width-100 header-font">I'm a senior UX/UI [Product] Designer with a passion for human-centered design and problem solving.</h3 >
                            <!-- <h6 class="text-white-2 width-75 lg-width-85 md-width-95 sm-width-100 d-none d-md-block">We are a full-service digital agency. Everything you could possibly want it to do and not only that, beautifully carefully designed.</h6> -->
                        </div>
                    </div> 
                </div>
            </div>
            ...
            <div class="container">
                <div class="row"> <!-- justify-content-center-->
                    <div class="col-12 col-lg-8">
                        ...
                        <div class="panel-group accordion-style1" id="accordion-design">
                            <div class="panel">
                                <div class="panel-heading">
                                    <h4 style="font-weight: 500!important;">Trained in both architecture and graphic design, and with 25+ of design experience, I have been focused on product design for the past 12 years.</h4>
                                </div>
                            </div>
                            ...
                            <div class="panel">
                                ...
                                <div id="design1" class="panel-collapse collapse" aria-expanded="false" role="tablist" >
                                ...
                                <div id="design3" class="panel-collapse collapse"  aria-expanded="false" role="tablist">
                                    ...
                                    <h6>
                                        <ul>
                                            ...
                                            <li>
                                                p.s. I believe in handshakes, not handoffs. Design and engineering's collaboration should start at the beginning of the project, and not when Jira tickets are created. It should be a constant, symbiotic relationship, where standups and critical touchpoints can ensure that challenges are tackled early on.
                                            </li>
                                            <li>[Añadir I’ve work with: HTML, CSS, SCSS, PHP, Javascript, React, Vue/Vuetify, GraphQL,]</li>
                                            <li>Before, branding</li>
                                        </ul>
                                    </h6>
                        ...
                        <p>
                        [NEED TO EDIT] Other facts about me
                        •	I’m a Jack of all trades, master of some – adaptability to tech platforms
                        •	I’m very research oriented
                        •	Some of my interests: Design system and documentation governance

                        Before focusing on UX/UI
                        I had a multi-disciplinary practice, and worked in mostly in branding, online advertising, web and mobile app projects for the technology, consultancy and banking sectors. I co-founded a women owned boutique interactive shop, and also led the online divisions for some of the top global advertising agencies, such as BBDO and TBWA.

                        </p>
                        <ul>
                            <li>1996, M. Arch / Tulane University, New Orleans</li>
                            <li>1998, M.S. Visual Communication / Pratt Institute, NYC</li>
    ...
    <!-- <section id="">
        ...
        <div class="row">
            <div class="col col-12">
                <h5>
                    I have 22+ years of experience in web technologies, and hold masters in architecture and graphic design.
                      My favorite challenges involve turning complex information and workflows into streamlined and intuitive journeys, always maintaining a relentless focus on real user needs, design heuristics, and best practices. 
                </h5>
                <h5>
                    I am experienced in the end-to-end UX process.  
                </h5>
                <h6>
                    <ul>
                        <li> I’m involved in: leading interviews and design thinking workshops with stakeholders; using AI-assisted research and synthesis to help drive discovery into ideation; prototyping ideas and testing their viability with business and engineering; shipping designs as close to code as possible, among others.</li>
