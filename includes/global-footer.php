        ...
        <footer class="footer-modern-dark bg-extra-dark-gray padding-five-tb sm-padding-30px-tb">
            <div class="footer-widget-area padding-40px-bottom sm-padding-30px-bottom">
                <div class="container">
                    <div class="row">
                        <!-- start slogan -->
                        <div class="col-lg-8 text-center text-md-left md-margin-three-bottom sm-margin-20px-bottom">
                            <img src="<?= BASE_URL ?>images/m3orange-logo-no-padding-white.png" style="max-height: 40px;"/>
                        </div>
                        <!-- end slogan -->
                        <!-- start social media -->
