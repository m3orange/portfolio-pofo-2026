...
<div class="row links-area">
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu font-weight-300">
                                                ...
                                                <li style="padding: 20px 0; border-top: 1px solid rgba(0,0,0,0.5); margin-top: 30px;">
                                                    <a href="<?= BASE_URL ?>earlier-work.php" title="Past Work">Earlier Work</a>
                                                </li>
                                            </ul>
                                        </li>
                ...
                <a href="https://www.linkedin.com/in/michellemunozdorna/" target="_blank"><img class="social-icons-header" src="<?= BASE_URL ?>images/logo-linkedin-black.svg"></a>
                                    </div>
