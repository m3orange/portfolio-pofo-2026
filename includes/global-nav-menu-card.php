...
<div class="row-for-mobile-cards row">
 ...
 <div class="col col-6 col-xl-1 col-lg-2 col-md-3 col-sm-6">
  ...
  <div class="col col-6 col-xl-1 col-lg-2 col-md-3 col-sm-6">
    <div class="mega-nav__card">
        ...
        <div class="margin-top-sm card-info">
            <div class="card-title"><a class="mega-nav__card-title" href="<?= BASE_URL ?>projects/musicasa/index.php" title="Musicasa">Musicasa</a></div>
            Mega_menu_snippet     
        </div>
    </div> 
</div>
 ...
 <div class="col col-6 col-xl-1 col-lg-2 col-md-3 col-sm-6">
    <div class="mega-nav__card">
        ...
        <div class="margin-top-sm card-info">
            <div class="card-title"><a class="mega-nav__card-title" href="<?= BASE_URL ?>projects/cx-roadmap/index.php" title="CX Roadmap">CX Roadmap</a></div>
            Mega_menu_snippet     
        </div>
    </div> 
</div>
 ...
 <div class="col col-6 col-xl-1 col-lg-2 col-md-3 col-sm-6">
    <div class="mega-nav__card">
        ...
        <div class="margin-top-sm card-info">
            <div class="card-title"><a class="mega-nav__card-title" href="<?= BASE_URL ?>projects/space-scout/index.php" title="In Situ">In Situ</a></div>
            Mega_menu_snippet     
        </div>
    </div> 
</div>
 ...
 <div class="col col-6 col-xl-1 col-lg-2 col-md-3 col-sm-6">
    <div class="mega-nav__card">
        ...
        <div class="margin-top-sm card-info">
            <div class="card-title"><a class="mega-nav__card-title" href="<?= BASE_URL ?>projects/map-tools/index.php" title="Map Tools">Map Tools</a></div>
            Mega_menu_snippet     
        </div>
    </div> 
</div>
 ...
 <div class="col col-6 col-xl-1 col-lg-2 col-md-3 col-sm-6">
    <div class="mega-nav__card">
        ...
        <div class="margin-top-sm card-info">
            <div class="card-title"><a class="mega-nav__card-title" href="<?= BASE_URL ?>projects/idd/index.php" title="IDD">IDD</a></div>
            Mega_menu_snippet     
        </div>
    </div> 
</div>
