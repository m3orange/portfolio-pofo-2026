...
<div class="orb-wrapper">
    ...
    <script type="module">
        ...
        import { OrbitControls } from '<?= BASE_URL ?>animations/ai-orb/OrbitControls.js';
        import { EffectComposer } from '<?= BASE_URL ?>animations/ai-orb/EffectComposer.js';
        import { RenderPass } from '<?= BASE_URL ?>animations/ai-orb/RenderPass.js';
        import { UnrealBloomPass } from '<?= BASE_URL ?>animations/ai-orb/UnrealBloomPass.js';
        ...
        // CONTROL STUBS
        const PARAMS = {"radius":60,"flow":0.54,"turb":0.38,"shell":0.24,"hueShift":0.13};
